...
ROOT_URLCONF = 'Afterword.urls'

# Static files (CSS, JavaScript, Images)
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'static',]  # ← Now BASE_DIR is defined
...
WSGI_APPLICATION = 'Afterword.wsgi.application'
...
AUTH_USER_MODEL = 'accounts.C_User'
